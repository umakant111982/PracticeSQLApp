        ...
        public void ParseAndAddProperty(JProperty property)
        {
            switch (property.Name)
            {
                ...
                case "System.AreaPath":     // Switch AreaPath and Iteration to match destination Team Project
                    Add("add", "/fields/" + property.Name.Trim(), null, Utility.ProcessAreasAndIterations(property.Value.ToString().Trim()));
                    break;
                case "System.IterationPath":
                    Add("add", "/fields/" + property.Name.Trim(), null, Utility.ProcessAreasAndIterations(property.Value.ToString().Trim()));
                    break;
                default:
                    Add("add", "/fields/" + property.Name.Trim(), null, property.Value.ToString().Trim());
                    break;
            }
        }
