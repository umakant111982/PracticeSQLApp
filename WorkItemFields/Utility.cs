...
namespace WorkItemFields
{
    public class Utility
    {
        ...
        public static async Task<string> CreateWIT(HttpClient client, string uri, HttpContent content, ILogger log)
        {
            try
            {
                ...
                using (HttpResponseMessage response = await client.PostAsync(uri, content))
                {
                    ...
                    log.LogInformation("Response StatusCode is : " + response.EnsureSuccessStatusCode().ToString());
